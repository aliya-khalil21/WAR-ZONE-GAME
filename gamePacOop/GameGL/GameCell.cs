        ...
        public GameCell nextCell(GameDirection direction)
        {
            ...
            if (direction == GameDirection.Left)
            {
                if (this.col > 0)
                {
                    ...
                    if (ncell.CurrentGameObject.GameObjectType == GameObjectType.NONE || ncell.CurrentGameObject.GameObjectType == GameObjectType.REWARD || ncell.CurrentGameObject.GameObjectType == GameObjectType.ENEMY)
                    {
                        return ncell;
                    }
                }
